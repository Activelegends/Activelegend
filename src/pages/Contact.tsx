...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900/70 via-gray-800/60 to-gray-900/70 backdrop-blur-md px-4 py-12 pt-24"><div className="min-h-screen flex flex-col items-center justify-center bg-black/30 backdrop-blur-xl px-4 py-12 pt-24">
      <motion.div
