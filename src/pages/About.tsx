...
export default function About() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex flex-col items-center justify-center px-4 py-16 pt-24">
      <motion.h1
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {/* نمونه اعضا - اطلاعات فرضی */}
          {[
            {
              name: 'محمد مهدی مولایاری',
              role: 'برنامه‌نویس و مدیر پروژه',
              img: '/team/moulaei.jpg',
              socials: [
                { icon: 'github', url: 'https://github.com/moulaei' },
                { icon: 'instagram', url: 'https://instagram.com/moulaei.dev' },
              ]
            },
            {
              name: 'علی رضایی',
              role: 'طراح بازی و گرافیست',
              img: '/team/rezaei.jpg',
              socials: [
                { icon: 'linkedin', url: 'https://linkedin.com/in/alirezaei' },
                { icon: 'instagram', url: 'https://instagram.com/alirezart' },
              ]
            },
            {
              name: 'سارا محمدی',
              role: 'نویسنده و مدیر محتوا',
              img: '/team/mohammadi.jpg',
              socials: [
                { icon: 'github', url: 'https://github.com/saramhd' },
                { icon: 'linkedin', url: 'https://linkedin.com/in/saramhd' },
              ]
            },
          ].map((member, i) => (
            <motion.div
